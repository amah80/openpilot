...
AWARENESS_DECEL = -0.1  # car smoothly decel at .2m/s^2 when user is distracted
A_CRUISE_MIN = -1.2
...
_DP_CRUISE_MIN_V =       [-0.70,  -0.80,  -0.90, -0.90,  -0.80, -0.70]
_DP_CRUISE_MIN_V_ECO =   [-0.65,  -0.60,  -0.73, -0.75,  -0.75, -0.75]
_DP_CRUISE_MIN_V_SPORT = [-0.75,  -0.90,  -0.95, -0.95,  -0.85, -0.65]
_DP_CRUISE_MIN_BP =      [0.,     0.07,   10.,   20.,    30.,   55.]

_DP_CRUISE_MAX_V =       [3.5, 3.5, 3.4, 3.0, 2.1, 1.61, 1.1,  0.63, 0.50, 0.33]
_DP_CRUISE_MAX_V_ECO =   [3.5, 3.4, 2.1, 1.6, 1.1, 0.91, 0.68, 0.44, 0.34, 0.13]
_DP_CRUISE_MAX_V_SPORT = [3.5, 3.5, 4.1, 3.7, 2.6, 1.96, 1.31,  0.74, 0.58, 0.43]
...
class LongitudinalPlanner:
  def __init__(self, CP, init_v=0.0, init_a=0.0):
    # dp
    self.dp_accel_profile_ctrl = True
    self.dp_accel_profile = DP_ACCEL_SPORT
    self.dp_following_profile_ctrl = True
